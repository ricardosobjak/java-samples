...
public class ArrayListExample {
    ...
    public static void main(String[] args) {
        ...
        List arraylistB = new LinkedList();
        ...
        // Iterando sobre o ArrayList para mostrar o seu conteúdo.
        ...
        System.out.println("'java' foi encontrada na posição : " + index);

        int lastIndex = arraylistB.lastIndexOf("java");
        System.out.println("'java' foi encontrada na posição  : " + lastIndex + " from the last");
        System.out.println();

        // Obtendo uma subLista a partir da lista original
        List subList = arraylistA.subList(3, arraylistA.size());

        System.out.println("Nova Sub-Lista(arraylistA) a partir índice 3 até "
        ...
        System.out.println("O arraylistA está vazio?   " + arraylistA.isEmpty());
        System.out.println();
