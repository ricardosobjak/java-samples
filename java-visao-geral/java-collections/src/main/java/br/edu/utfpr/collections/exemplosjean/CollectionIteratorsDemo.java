...
public class CollectionIteratorsDemo {
	...
	/**
	 * in spite of removing elements, list iterator
	 * allows the modification of individual elements
	...
	/**
	 * Can remove elements from the list but not
	 * set/modify individual elements
	 */
	 ...
	 * Using an Iterator allows you to delete elements, but not replace
	 * an existing element or add a new one. That leaves ListIterator.
	 */
